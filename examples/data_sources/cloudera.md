---
layout: "dsfhub"
page_title: "Example dsfhub_data_source Resource for CLOUDERA"
description: |-
Provides a dsfhub_data_source resource for CLOUDERA.
---
...
resource "dsfhub_data_source" "example_cloudera" {
	...
	# audit_type = var.audit_type # Example Values: "CLOUDERA", "CLOUDERA_7"	# Used to indicate what mechanism should be used to fetch logs on systems supporting multiple ways to get logs, see asset specific documentation for details
