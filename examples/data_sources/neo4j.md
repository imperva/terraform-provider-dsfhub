---
layout: "dsfhub"
page_title: "Example dsfhub_data_source Resource for NEO4J"
description: |-
Provides a dsfhub_data_source resource for NEO4J.
---
...
resource "dsfhub_data_source" "example_neo4j" {
	...
	# audit_type = var.audit_type # Example Values: "SYSLOG", "SERVICE", "SERVICE_4", "SYSLOG_3_5", "AGGREGATED"	# Used to indicate what mechanism should be used to fetch logs on systems supporting multiple ways to get logs, see asset specific documentation for details
